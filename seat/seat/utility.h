...
namespace UtilityFunctions
{
	...
	template<typename T> 
	void OutputLine(std::ostream & out, const T & t)
	    {out << t << std::endl;}
	template<typename T, typename S> 
	void OutputLine(std::ostream & out, const T & t, const S & s)
	    {out << t << " " << s << std::endl;}
	template<typename T, typename S, typename U> 
	void OutputLine(std::ostream & out, const T & t, const S & s, const U & u)
	    {out << t << " " << s << " " << u << std::endl;}
	template<typename T, typename S, typename U, typename V> 
	void OutputLine(std::ostream & out, const T & t, const S & s, const U & u, const V & v)
	    {out << t << " " << s << " " << u << " " << v << std::endl;}
	template<typename T, typename S, typename U, typename V, typename W> 
	void OutputLine(std::ostream & out, const T & t, const S & s, const U & u, const V & v, const W & w)
	    {out << t << " " << s << " " << u << " " << v << " " << w << std::endl;}
	    

	template<typename T> void OutputLine(const T & t)
	    {OutputLine<T>(std::cout, t);}
	template<typename T, typename S> void OutputLine(const T & t, const S & s)
	    {OutputLine<T, S>(std::cout, t, s);}
    template<typename T, typename S, typename U> void OutputLine(const T & t, const S & s, const U & u)
	    {OutputLine<T, S, U>(std::cout, t, s, u);}
    template<typename T, typename S, typename U, typename V> 
	void OutputLine(const T & t, const S & s, const U & u, const V & v)
	    {OutputLine<T, S, U>(std::cout, t, s, u, v);}
    template<typename T, typename S, typename U, typename V, typename W> 
	void OutputLine(const T & t, const S & s, const U & u, const V & v, const W & w)
	    {OutputLine<T, S, U>(std::cout, t, s, u, v, w);}
    ...
    //XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    //	PrintVector() and PrintArray()
    //XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

    template<typename T> void PrintArray(const std::vector<std::vector<T> > & combs)
    {
        long N = combs.size();
        for(long i = 0; i != N;  ++i)
        {
    ...
    template<typename T> void PrintVector(const std::vector<T> & tab)
    {
        long N = tab.size();
        for(long i = 0; i != N;  ++i)
        {
